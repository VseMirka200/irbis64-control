...
class IrbisConnectionDialog(QDialog):
    ...
    def __init__(
        ...
        self.database_combo = AppComboBox()
        ...
        # Свободное место диалога должно оставаться под формой. Без отдельной
        # растяжки QVBoxLayout увеличивает высоту заголовка и подсказки.
        layout.addStretch(1)
